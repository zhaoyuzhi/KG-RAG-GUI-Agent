...
def search_on_feature_lists(cur_screenshot, feature_path, threshold=0.95):
    """
...
#     cur_screenshot = "/home/pp/app_agent/RAGGeneration_New/code/AppAgent_online-dev3/logs/2024-12-04/11-51-36/ctrip_携程查询火车票/screenshot/output_image_0.png"
    ...
    if len(image_name)  > 0:
        with open(f'/home/app_agent/RAG_Generation/data/oracle_test_app_second_stage/{package_name}/graph/{package_name}_node_available_path_template.json', 'r', encoding='utf-8') as file:
            data = json.load(file)

        all_intention = data[image_name]
        intention_template_list = []
        for intent_info in all_intention:
            intention_template_list.append(intent_info["tempolate"])
...
if __name__ == "__main__":
    ...
    max_similarity, max_img_name = search_on_feature_lists("/home/app_agent/RAG_Generation/code/AppAgent_online-dev3/logs/2024-12-09/02-40-52/ctrip_携程搜索并查看酒店/screenshot/output_image_0.png", 
                            "/home/app_agent/RAG_Generation/data/oracle_test_app_second_stage/com.ctrip.harmonynext/graph/com.ctrip.harmonynext_image_feature.pkl", 
                            threshold=0.99)
