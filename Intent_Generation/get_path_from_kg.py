...
if __name__ == "__main__":
    # 加载图谱json
    dist_data_path = "/home/dataset/top225/top225_sort_type/影音娱乐/影音娱乐视频垂类/com.qiyi.video/dist/static/com.qiyi.video.json"
    ...
    # 获取从起始点开始到所有节点的路径
    all_path_list = get_random_path(relation_graph_for_shortestpath)
