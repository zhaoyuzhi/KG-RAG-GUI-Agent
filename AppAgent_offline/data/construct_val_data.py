...
if __name__ == '__main__':
    ...
    number = 0
    root = "true_path_data"
    selected_package_list = ['com.sankuai.hmeituan', 'com.ss.hm.ugc.aweme',"com.alipay.mobile.client","com.qiyi.video.hmy"]
    ...
    for package in selected_package_list:#os.listdir(root):
        #if package.startswith("com"):
        ...
        for idx, item in enumerate(data_,start=1):
            ...
            json_data = {"id":"%s%02d"%(abbr_package,idx),"intent": intent, "sceneIdList": sceneIdList, "commandList": action_trace, "package": package}
            ...
            # yaml.safe_dump(json2yaml_data, sys.stdout, default_flow_style=False)
            # yaml.dump(json2yaml_data, ff, allow_unicode=True)
                # for key, value in item.items():
                #     print(key, value)
        save_jsonl(intent_sequence_pair_list, os.path.join(root, "%s_intent_sequence_pair.jsonl"%package))
